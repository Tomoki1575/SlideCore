...
public sealed class ScrollRectPool : MonoBehaviour, LoopScrollPrefabSource, LoopScrollDataSource
{
    ...
    // イベントハンドラー
    public void OnPointerDown(BaseEventData eventData) { IsPointerDown = true; Debug.Log("Down"); }
    public void OnPointerUp(BaseEventData eventData)  {IsPointerDown = false; Debug.Log("Up"); }

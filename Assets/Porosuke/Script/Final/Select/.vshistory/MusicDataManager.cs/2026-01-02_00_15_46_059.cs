...
public class MusicDataManager : MonoBehaviour
{
    ...
    public event Action<List<MusicData>> OnDisplayMusicDataListChanged;
    ...
    public void SetDifficulty(Difficulty difficulty)
    {
        ...
        OnDisplayMusicDataListChanged?.Invoke(CurrentDisplayMusicDataList);
    }

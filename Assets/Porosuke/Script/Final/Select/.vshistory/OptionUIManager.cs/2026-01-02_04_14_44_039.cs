...
public class OptionUIManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        BaseNoteSpeedText.text = OptionData.UserNoteSpeed.ToString("F2");
        StartOffsetText.text = OptionData.NoteStartOffset.ToString();
        JudgeOffsetText.text = OptionData.JudgeOffset.ToString("F2");
        BGMText.text = ((int)(OptionData.BGMVolume * 100)).ToString();
        SEText.text = ((int)(OptionData.SEVolume * 100)).ToString();
    }

...
public class MusicElement : MonoBehaviour
{
    ...
    public void OnPointerDown(BaseEventData eventData) { OnPointerDownEvent?.Invoke(); Debug.LogWarning("Down"); }
    public void OnPointerUp(BaseEventData eventData) => OnPointerUpEvent?.Invoke();
}

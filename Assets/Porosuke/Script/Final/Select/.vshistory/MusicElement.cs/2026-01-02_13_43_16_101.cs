...
public class MusicElement : MonoBehaviour, IPointerClickHandler
{
    ...
    public void SetElementData(MusicData musicData, MusicDataManager.Difficulty difficulty, Color levelColor, int index)
    {
        // レベルの背景色を設定
        ...
        ArtistText.text = index.ToString();
    }
    ...
    public void OnPointerClick(PointerEventData eventData) { if (!eventData.dragging) OnButtonPressed(); }
}

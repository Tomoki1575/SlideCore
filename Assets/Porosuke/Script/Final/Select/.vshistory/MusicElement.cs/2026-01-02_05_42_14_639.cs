...
public class MusicElement : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        ButtonPointerNotifier bPN = BackButton.GetComponent<ButtonPointerNotifier>();
        // Buttonに吸われた入力を更にActionに渡す
        bPN.OnPointerDownEvent += OnPointerDown;
        bPN.OnPointerUpEvent += OnPointerUp;
    }

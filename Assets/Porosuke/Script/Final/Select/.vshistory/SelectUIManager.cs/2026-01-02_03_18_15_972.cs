...
public class SelectUIManager : MonoBehaviour
{
    ...
    private void SetMusicDataUI(MusicData musicData)
    {
        ...
        if (NormalButton.interactable != hasNormal) NormalButton.interactable = hasNormal;
        bool hasHard = musicData.chartHard != null;
        if (HardButton.interactable != hasHard) HardButton.interactable = hasHard;
    ...
    {
        MusicDataManagerClass.SetDifficulty(difficulty);
    }

...
public class NotePoolManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Debug.Log((int)LaneRect.sizeDelta.x);
        PreparePool();
    }
    ...
    private Prefab CreatePrefab(NoteType type)
    {
        ...
        prefab.obj.transform.SetParent(LaneRect, false);
    ...
    public Prefab GetNote(NoteData noteData)
    {
        ...
        // Xをセット
        prefab.nc.SetPositionX(GetPositionXByLane((int)LaneRect.sizeDelta.x, noteData.lane));
        // 位置を一番上に

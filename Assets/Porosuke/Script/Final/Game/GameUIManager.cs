...
public class GameUIManager : MonoBehaviour
{
    ...
    public void SetConstantUI()
    {
        ...
        OffsetSlider.SetDirection(OffsetSec >= 0 ? Slider.Direction.LeftToRight : Slider.Direction.RightToLeft, true);
    ...
    public void SetModifyUI(double virtualTime, bool bStartPlay, bool bPause, NoteData firstNoteData)
    {
        ...
        SetText(RemainNoteText, $"RemainNoteCount : {NoteQueueSize}");

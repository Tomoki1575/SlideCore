...
public class NoteDataManager : MonoBehaviour
{
    ...
    // 変数
    public List<SpeedScaleData> SpeedScaleList { get; private set; }
    public List<NoteData> NoteList { get; private set; }
    public MetaData ChartMetaData { get; private set; }
    ...
    public void TempInit(float AudioLength)
    {
        ...
        NoteList.Add(MakeNoteData(MusicStartWaitTime + 0, 0, NoteType.Tap, false, 0, false));
        NoteList.Add(MakeNoteData(MusicStartWaitTime + 2, 3, NoteType.Tap, true, 0, false));
        NoteList.Add(MakeNoteData(MusicStartWaitTime + 8, 1, NoteType.Tap, false, 0, false));
        NoteList.Add(MakeNoteData(MusicStartWaitTime + 14, 4, NoteType.Tap, false, 0, false));
        NoteList.Add(MakeNoteData(MusicStartWaitTime + 18, 2, NoteType.Tap, true, 0, false));
        NoteList.Add(MakeNoteData(MusicStartWaitTime + 20, 0, NoteType.Tap, false, 0, false));
        NoteList.Add(MakeNoteData(MusicStartWaitTime + 26, 0, NoteType.Tap, false, 0, false));
        NoteList.Add(MakeNoteData(MusicStartWaitTime + 38, 5, NoteType.Tap, false, 0, false));
        NoteList.Add(MakeNoteData(MusicStartWaitTime + 42, 5, NoteType.Tap, false, 0, false));
    }
